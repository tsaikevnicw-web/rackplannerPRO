            ...
            {containers.map((container) => {
                ...
                return (
                    <div key={container.id} className="w-full max-w-7xl mx-auto flex flex-col items-center relative group/container">
                        ...
                        <div className="w-full flex flex-wrap items-center justify-between bg-[#0b1523]/80 border border-slate-700/40 rounded-2xl px-6 py-3.5 mb-4 shadow-[0_4px_20px_rgba(0,0,0,0.2)] gap-4">
                            ...
                            <div className="flex items-center gap-2 bg-slate-950/80 p-1 rounded-xl border border-slate-800">
                                ...
                                {currentLayoutMode === 'topdown' && (
                                    <button
                                        ...
                                        className="flex items-center gap-1 px-2.5 py-1 bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-700 rounded-lg text-xs font-semibold transition-colors ml-1"
                                        title="一鍵自動將機櫃整齊對齊排列"
                                    >
                        ...
                        {currentLayoutMode === 'topdown' ? (
                            ...
                            <div 
                                ...
                                className="relative w-full min-h-[420px] bg-[#09111e] border-[6px] border-slate-700/80 rounded-3xl p-6 shadow-[0_24px_50px_rgba(0,0,0,0.7)] overflow-hidden mb-8 group/canvas"
                            >
                                {/* 貨櫃俯視對稱金屬外框與雙開門細節 */}
                                <div className="absolute top-0 left-0 bottom-0 w-4 bg-gradient-to-r from-slate-700 via-slate-800 to-slate-900 border-r border-slate-950 flex flex-col justify-around py-4 z-10">
                                    <div className="w-full h-12 bg-slate-950/80 rounded-r border-y border-slate-600"></div>
                                    <div className="w-full h-12 bg-slate-950/80 rounded-r border-y border-slate-600"></div>
                                </div>
                                <div className="absolute top-0 right-0 bottom-0 w-4 bg-gradient-to-l from-slate-700 via-slate-800 to-slate-900 border-l border-slate-950 flex flex-col justify-around py-4 z-10">
                                    <div className="w-full h-12 bg-slate-950/80 rounded-l border-y border-slate-600"></div>
                                    <div className="w-full h-12 bg-slate-950/80 rounded-l border-y border-slate-600"></div>
                                </div>
                                <div 
                                ...
                                <div 
                                    ...
                                    className="relative min-h-[360px] w-full border border-slate-800/80 rounded-2xl bg-slate-950/60 p-4 overflow-hidden"
                                >
                                        ...
                                        if (isZone) {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    {/* Hover 懸浮工具列 (旋轉 / 刪除) */}
                                                    <div 
                                                        className="absolute -top-8 left-1/2 -translate-x-1/2 hidden group-hover/rack:flex items-center gap-1 z-30 bg-slate-950/95 p-1 rounded-lg border border-slate-700 shadow-xl whitespace-nowrap"
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`absolute rounded-xl border-2 flex flex-col justify-between p-2 transition-shadow cursor-grab active:cursor-grabbing group/rack z-10 select-none ${
                                                    isActive 
                                                        ? 'border-indigo-400 bg-slate-900/95 ring-4 ring-indigo-500/30 shadow-[0_0_20px_rgba(99,102,241,0.4)]'
                                                        : 'border-slate-700 bg-slate-900/90 hover:border-indigo-500/70 hover:shadow-lg'
                                                }`}
                                            >
                                                {/* 紅藍進風 / 出風區塊與手動切換箭頭 */}
                                                ...
                                                <div className="flex justify-between items-center w-full pt-1">
                                                    <span className="text-[8px] font-mono text-slate-400 font-bold truncate max-w-[30px]">
                                                        #{rack.slotIndex !== undefined && rack.slotIndex !== null ? rack.slotIndex + 1 : idx + 1}
                                                    </span>
                                                    <div className={`p-0.5 rounded bg-slate-950 border ${theme.border} text-slate-300`}>
                                                ...
                                                <div className="flex flex-col items-center justify-center my-0.5 w-full text-center">
                                                    ...
                                                    <span className="text-[8px] text-slate-400 font-mono scale-90 truncate max-w-full">{rack.type}</span>
                                                </div>

                                                {/* 功耗與重量 */}
                                                <div className="text-[8px] font-mono text-slate-400 border-t border-slate-800 pt-0.5 text-center truncate">
                                                ...
                                                >
                                                    ...
                                                    {(rack.type === 'General' || rack.type === 'ORv3') && (
                                                        <button
                                                            ...
                                                            className="p-1 bg-slate-800 hover:bg-slate-700 border border-slate-600 rounded text-slate-200 transition-colors"
                                                            title="進入內部單櫃編輯"
                                                        >
                                    ...
                                    {activeContainerRacks.length === 0 && (
                                        <div className="w-full h-full min-h-[220px] flex flex-col items-center justify-center text-slate-500 space-y-2 border-2 border-dashed border-slate-800 rounded-xl">
                                            <Move className="w-8 h-8 text-indigo-400/50 animate-bounce" />
                                            <div className="text-xs font-bold text-slate-400">目前貨櫃尚無放置任何機櫃或基礎設施</div>
